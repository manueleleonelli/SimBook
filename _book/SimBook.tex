...
\begin{center}\includegraphics[width=0.5\linewidth]{SimBook_files/figure-latex/unnamed-chunk-103-1} \end{center}
...
{\centering \includegraphics[width=0.5\linewidth]{SimBook_files/figure-latex/cumwin-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{SimBook_files/figure-latex/mcumwin-1} 
